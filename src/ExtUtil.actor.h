...
runRYWTransaction(Reference<FDB::Database> db, Function func, int64_t retryLimit, int64_t timeout) {
...
runTransactionAsync(Reference<FDB::Database> db, Function func, int64_t retryLimit, int64_t timeout) {
